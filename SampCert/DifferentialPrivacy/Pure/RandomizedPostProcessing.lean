...
namespace SLang
/-This file establishes the post-processing property for randomized post-processing functions-/

/-Composes a mechanism with a randomized post-processing function-/
...
/-Provides a pointwise guarantee of a DP bound-/
...
/-Provides a pointwise guarantee of a DP bound but for our DP_withUpdateNeighbour-/
...
theorem randPostProcess_DP_bound {T U V : Type} {nq : Mechanism T U} {ε : NNReal} (h : PureDP nq ε) (g : U → PMF V) :
...
theorem randPostProcess_DP_bound_with_UpdateNeighbour {T U V : Type} {nq : Mechanism T U} {ε : Real} (h : DP_withUpdateNeighbour nq ε) (g : U → PMF V) :
